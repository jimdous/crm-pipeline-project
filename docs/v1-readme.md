> Historical V1 document, preserved from commit 2221949. Its schema and metric claims do not describe V2 and were not independently verified. Current setup, implemented tables, and canonical data are documented in the root README. The images below are historical captures, not the current application.
...
![CRM Entity Relationship Diagram](crm_erd.png)
